...
# loop running over the datasets in sample_list for all the classifiers. Generates ROC curves and metrics
for sample in sample_list:
    X_train, Y_train, X_test, Y_test = data.dataset(sample,'',False,0.4)

    mc.comparison(sample, X_train, Y_train, X_test, Y_test)
